...
call :download "%BASE_URL%/onlyoffice/index.html?v=ms8vbr9y" "%PLUGIN_DIR%\index.html" || exit /b 1
call :download "%BASE_URL%/onlyoffice/settings.html?v=ms8vbr9y" "%PLUGIN_DIR%\settings.html" || exit /b 1
call :download "%BASE_URL%/onlyoffice/workflow-editor.html?v=ms8vbr9y" "%PLUGIN_DIR%\workflow-editor.html" || exit /b 1
...
>> "%PS1%" echo   $html = $html -replace '(src=["''].*?/onlyoffice/assets/.*?\.js)(["''])', '$1?v=ms8vbr9y$2'
>> "%PS1%" echo   $html = $html -replace '(href=["''].*?/onlyoffice/assets/.*?\.css)(["''])', '$1?v=ms8vbr9y$2'
...
>> "%PLUGIN_DIR%\config.json" echo       "url": "index.html?v=ms8vbr9y",
