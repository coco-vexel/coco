...
call :download "%BASE_URL%/onlyoffice/index.html?v=ms7dider" "%PLUGIN_DIR%\index.html" || exit /b 1
call :download "%BASE_URL%/onlyoffice/settings.html?v=ms7dider" "%PLUGIN_DIR%\settings.html" || exit /b 1
call :download "%BASE_URL%/onlyoffice/workflow-editor.html?v=ms7dider" "%PLUGIN_DIR%\workflow-editor.html" || exit /b 1
...
>> "%PLUGIN_DIR%\config.json" echo       "url": "index.html?v=ms7dider",
...
echo.
echo Remote UI:
echo   %BASE_URL%/onlyoffice/?v=ms7dider
echo API:
echo   %API_BASE_URL%
