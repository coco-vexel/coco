...
call :download "%BASE_URL%/onlyoffice/index.html?v=ms2mp63y" "%PLUGIN_DIR%\index.html" || exit /b 1
call :download "%BASE_URL%/onlyoffice/settings.html?v=ms2mp63y" "%PLUGIN_DIR%\settings.html" || exit /b 1
call :download "%BASE_URL%/onlyoffice/workflow-editor.html?v=ms2mp63y" "%PLUGIN_DIR%\workflow-editor.html" || exit /b 1
